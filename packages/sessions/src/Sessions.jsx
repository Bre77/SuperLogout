...
export default () => {
    return (
        <QueryClientProvider client={queryClient}>
            <p>
                Active HTTP authentication sessions on this Splunk server are shown below. With this
                tool you can remove these sessions, which is useful if an account has been removed
                from your identity provider. Search authentications are not shown intentionally, as
                terminating these has no value.
            </p>
            <Sessions />
        </QueryClientProvider>
    );
